...
2. Download the latest release ZIP file (e.g., `orange-InteractiveCameraTweak-1.0.0.zip`) from the [Releases](https://github.com/orange/InteractiveCameraTweak/releases) page.
